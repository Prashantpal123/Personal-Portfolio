    ...
    return (
        ...
        <div className='  flex mx-4 md:mx-8 gap-4 md:gap-20 md:justify-center md:mt-20' id='home'>
                ...
                <div className='md:mt-16'>
                    ...
                    <button className='bg-[#fcbb38] font-[700] px-2 md:px-4 py-2 border border-amber-50   rounded-3xl cursor-pointer'>
                            Hire <span className='text-[#f4f4f4] '>Me</span>
                        </button>
                        <button className='text-[#f4f4f4] border border-amber-50 font-[700] px-3 py-2 rounded-3xl cursor-pointer'>
                            Projects
                        </button>
